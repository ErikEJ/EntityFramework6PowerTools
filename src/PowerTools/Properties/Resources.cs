...
namespace Microsoft.DbContextPackage.Resources
{
    ...
    internal static class Strings
    {
        ...
        /// </summary>
        internal static string AddTemplatesError => EntityRes.GetString(EntityRes.AddTemplatesError);

        /// <summary>
        ///     A string like "Build failed. Unable to discover a DbContext class."
        /// </summary>
        internal static string BuildFailed => EntityRes.GetString(EntityRes.BuildFailed);

        /// <summary>
        ///     A string like "An error occurred while trying to load the configuration file. See the Output window for details."
        /// </summary>
        internal static string LoadConfigFailed => EntityRes.GetString(EntityRes.LoadConfigFailed);

        /// <summary>
        ///     A string like "A constructible type deriving from DbContext could not be found in the selected file."
        /// </summary>
        internal static string NoContext => EntityRes.GetString(EntityRes.NoContext);

        /// <summary>
        ///     A string like "An error occurred while reverse engineering Code First. See the Output window for details."
        /// </summary>
        internal static string ReverseEngineer_Error => EntityRes.GetString(EntityRes.ReverseEngineer_Error);

        /// <summary>
        ///     A string like "Generating context..."
        /// </summary>
        internal static string ReverseEngineer_GenerateContext =>
            EntityRes.GetString(EntityRes.ReverseEngineer_GenerateContext);

        /// <summary>
        ///     A string like "Generating default mapping..."
        /// </summary>
        internal static string ReverseEngineer_GenerateMapping =>
            EntityRes.GetString(EntityRes.ReverseEngineer_GenerateMapping);

        /// <summary>
        ///     A string like "Installing EntityFramework package..."
        /// </summary>
        internal static string ReverseEngineer_InstallEntityFramework =>
            EntityRes.GetString(EntityRes.ReverseEngineer_InstallEntityFramework);

        /// <summary>
        ///     A string like "An error occurred while trying to install the EntityFramework package. See the Output window for
        ///     details."
        /// </summary>
        internal static string ReverseEngineer_InstallEntityFrameworkError =>
            EntityRes.GetString(EntityRes.ReverseEngineer_InstallEntityFrameworkError);

        /// <summary>
        ///     A string like "Loading schema information..."
        /// </summary>
        internal static string ReverseEngineer_LoadSchema => EntityRes.GetString(EntityRes.ReverseEngineer_LoadSchema);
        ...
        internal static string ReverseEngineer_SchemaError =>
            EntityRes.GetString(EntityRes.ReverseEngineer_SchemaError);

        /// <summary>
        ///     A string like "You are using a version of the Entity Framework that is not supported by the Power Tools. Please
        ///     upgrade to Entity Framework 4.2 or later."
        /// </summary>
        internal static string UnsupportedVersion => EntityRes.GetString(EntityRes.UnsupportedVersion);
        ...
        /// <summary>
        ///     A string like "An error occurred while trying to instantiate the DbContext type {0}. See the Output window for
        ///     details."
        /// </summary>
        ...
        /// <summary>
        ///     A string like "An error occurred while trying to initialize view generation for the DbContext type {0}. See the
        ...
        /// <summary>
        ///     A string like "An error occurred while trying to initialize view generation for the Entity Data Model {0}. See the
        ///     Output window for details."
        /// </summary>
    ...
    internal static class Error
    {
        ...
        /// <summary>
        ///     InvalidOperationException with message like "You are using a version of the Entity Framework that is not supported
        ///     by the Power Tools. Please upgrade to Entity Framework 4.2 or later."
        /// </summary>
    ...
    internal sealed class EntityRes
    {
        ...
        internal const string ReverseEngineer_InstallEntityFrameworkError =
            "ReverseEngineer_InstallEntityFrameworkError";
        ...
        private EntityRes()
        {
            resources = new ResourceManager("Microsoft.DbContextPackage.Properties.Resources",
                typeof(DbContextPackage).Assembly);
        }
        ...
        public static string GetString(string name, params object[] args)
        {
            ...
            if (args != null && args.Length > 0)
            {
                ...
                {
                    if (args[i] is string value && value.Length > 1024) args[i] = value.Substring(0, 1024 - 3) + "...";
                }
